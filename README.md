...
Application
High-Frequency OutputBypass

Selection Justification
Ceramic capacitors exhibit:
Low ESR
Low ESL
...
By placing the 10 µF ceramic capacitor in parallel with the 220 µF electrolytic capacitor:
Low-frequency ripple is reduced by the electrolytic capacitor.
High-frequency ripple is reduced by the ceramic capacitor.
Output voltage stability is improved.
Transient response is enhanced.
Final Output Filter Network
Component
Function
220 µF Electrolytic Capacitor
Bulk energy storage and low-frequency ripple reduction
10 µF Ceramic Capacitor
High-frequency noise suppression and transient filtering
